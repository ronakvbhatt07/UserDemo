...
namespace UserDataAccess
{
    ...
    public partial class userInfoEntities : DbContext
    {
        ...
        public virtual int sp_UpdateUserDetails(Nullable<decimal> iD, string name, Nullable<decimal> age, Nullable<decimal> salary, string designation, Nullable<System.DateTime> dOB, string last_name,string location)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_UpdateUserDetails", iDParameter, nameParameter, ageParameter, salaryParameter, designationParameter, dOBParameter, last_nameParameter, locationParameter);
        }
    }
}
